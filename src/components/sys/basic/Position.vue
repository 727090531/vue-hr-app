    ...
    <div>
        <div>
            <el-input size="small" class="input_type" placeholder="添加职位..."
                      prefix-icon="el-icon-plus" @keydown.enter.native="addPosition" v-model="pos.name"></el-input>
            ...
            <el-upload
                ...
                <el-button class="el-export" :disabled="importBtnDisabled" type="success" :icon="importBtnIcon" size="small">
                    {{importBtnText}}
                </el-button>
            </el-upload>
